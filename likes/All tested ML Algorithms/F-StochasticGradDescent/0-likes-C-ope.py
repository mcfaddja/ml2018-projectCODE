...
#mySGD.fit(likesMAT, opesARR)
mySGD.fit(X_train, y_train)

y_pred = mySGD.predict(X_test)
import math
myRMSE = math.sqrt(metrics.mean_squared_error(y_test, y_pred))
print("opes, Stochastic Grad Descent:  ", str(myAlpha), " ", myRMSE)

# joblib.dump(mySGD, "/Users/jamster/mySGD-A-opes.xz", compress=9)

# impmySGD = joblib.load("/Users/jamster/mySGD-A-opes.xz")