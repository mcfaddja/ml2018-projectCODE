...
print("ages, SVM:  ", str(myTOL), " ", mySVM.score(X_test, y_test))

# joblib.dump(mySVM, "/Users/jamster/SVM-A-ages.xz", compress=9)

# impSVM = joblib.load("/Users/jamster/SVM-A-ages.xz")