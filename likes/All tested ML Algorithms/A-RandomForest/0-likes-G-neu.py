...
#randFor.fit(likesMAT, neusARR)
randFor.fit(X_train, y_train)

y_pred = randFor.predict(X_test)
import math
myRMSE = math.sqrt(metrics.mean_squared_error(y_test, y_pred))
print("neus, random forest:  ", str(nEST), " ", myRMSE)

# joblib.dump(randFor, "/Users/jamster/randfor-A-neus.xz", compress=9)

# impRandfor = joblib.load("/Users/jamster/randfor-A-neus.xz")
