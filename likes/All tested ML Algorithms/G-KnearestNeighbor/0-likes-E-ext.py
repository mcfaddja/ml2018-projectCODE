...
#knn.fit(likesMAT, extsARR)
knn.fit(X_train, y_train)

y_pred = knn.predict(X_test)
import math
myRMSE = math.sqrt(metrics.mean_squared_error(y_test, y_pred))
print("exts, K-nearest neighbor:  ", str(nNEIGHs), " ", myRMSE)

# joblib.dump(knn, "/Users/jamster/knn-A-exts.xz", compress=9)

# impKNN = joblib.load("/Users/jamster/knn-A-exts.xz")