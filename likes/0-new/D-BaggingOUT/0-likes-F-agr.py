...
#bagOUT.fit(likesMAT, agrsARR)
bagOUT.fit(X_train, y_train)

print("agrs, bagOUT:  ", str(nEST), " ", bagOUT.score(X_test, y_test))

# joblib.dump(bagOUT, "/Users/jamster/bagOUT-A-agrs.xz", compress=9)

# impbagOUT = joblib.load("/Users/jamster/bagOUT-A-agrs.xz")