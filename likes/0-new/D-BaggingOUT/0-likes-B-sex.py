...
print("sexs, bagOUT:  ", str(nEST), " ", bagOUT.score(X_test, y_test))

# joblib.dump(bagOUT, "/Users/jamster/bagOUT-A-sexs.xz", compress=9)

# impbagOUT = joblib.load("/Users/jamster/bagOUT-A-sexs.xz")