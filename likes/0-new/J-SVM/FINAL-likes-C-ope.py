...
myTOL = 1e-6
mySVM = SVR(tol=myTOL)
mySVM.fit(likesMAT, opesARR)
#mySVM.fit(X_train, y_train)

# y_pred = mySVM.predict(X_test)
# import math
# myRMSE = math.sqrt(metrics.mean_squared_error(y_test, y_pred))
# print("opes, SVM:  ", str(myTOL), " ", myRMSE)

print("done training")

joblib.dump(mySVM, "/Users/jamster/SVM-A-opes.xz", compress=9)
print("model written to disk")

impSVM = joblib.load("/Users/jamster/SVM-A-opes.xz")
print("import test sucessful")