...
mySGD = SGDClassifier(alpha=myAlpha)

#mySGD.fit(likesMAT, sexsARR)
mySGD.fit(X_train, y_train)

print("sexs, Stochastic Grad Descent:  ", str(myAlpha), " ", mySGD.score(X_test, y_test))

# joblib.dump(mySGD, "/Users/jamster/mySGD-A-sexs.xz", compress=9)

# impmySGD = joblib.load("/Users/jamster/mySGD-A-sexs.xz")