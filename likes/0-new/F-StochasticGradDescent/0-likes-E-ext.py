...
#mySGD.fit(likesMAT, extsARR)
mySGD.fit(X_train, y_train)

y_pred = mySGD.predict(X_test)
import math
myRMSE = math.sqrt(metrics.mean_squared_error(y_test, y_pred))
print("exts, Stochastic Grad Descent:  ", str(myAlpha), " ", myRMSE)

# joblib.dump(mySGD, "/Users/jamster/mySGD-A-exts.xz", compress=9)

# impmySGD = joblib.load("/Users/jamster/mySGD-A-exts.xz")