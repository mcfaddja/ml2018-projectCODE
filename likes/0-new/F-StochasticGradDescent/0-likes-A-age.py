...
#mySGD.fit(likesMAT, agesARR)
mySGD.fit(X_train, y_train)

print("ages, Stochastic Grad Descent:  ", str(myAlpha), " ", mySGD.score(X_test, y_test))

# joblib.dump(mySGD, "/Users/jamster/mySGD-A-ages.xz", compress=9)

# impmySGD = joblib.load("/Users/jamster/mySGD-A-ages.xz")