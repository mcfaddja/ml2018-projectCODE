...
#bernNB.fit(likesMAT, agesARR)
bernNB.fit(X_train, y_train)

print("ages, Bernoulli Naive Bays:  ", str(myBin), " ", str(myAlpha), " ", bernNB.score(X_test, y_test))

# joblib.dump(randFor, "/Users/jamster/bernNB-A-ages.xz", compress=9)

# impRandfor = joblib.load("/Users/jamster/bernNB-A-ages.xz")