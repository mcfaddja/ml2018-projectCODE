...
bernNB = BernoulliNB(alpha=myAlpha, binarize=myBin)

#bernNB.fit(likesMAT, sexsARR)
bernNB.fit(X_train, y_train)

print("sexs, Bernoulli Naive Bays:  ", str(myBin), " ", str(myAlpha), " ", bernNB.score(X_test, y_test))

# joblib.dump(randFor, "/Users/jamster/bernNB-A-sexs.xz", compress=9)

# impRandfor = joblib.load("/Users/jamster/bernNB-A-sexs.xz")