...
print("ages, bagIN:  ", str(nEST), " ", bagIN.score(X_test, y_test))

# joblib.dump(bagIN, "/Users/jamster/bagIN-A-ages.xz", compress=9)

# impbagIN = joblib.load("/Users/jamster/bagIN-A-ages.xz")