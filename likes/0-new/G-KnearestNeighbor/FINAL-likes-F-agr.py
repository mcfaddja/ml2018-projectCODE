...
joblib.dump(knn, "/Users/jamster/knn-A-agrs.xz", compress=9)
print("saved model to disk")

impKNN = joblib.load("/Users/jamster/knn-A-agrs.xz")
print("test import succeeded")