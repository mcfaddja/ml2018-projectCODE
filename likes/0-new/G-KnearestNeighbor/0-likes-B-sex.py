...
knn = KNeighborsClassifier(n_jobs=nJOBS, n_neighbors=nNEIGHs)

#knn.fit(likesMAT, sexsARR)
knn.fit(X_train, y_train)

print("sexs, K-nearest neighbor:  ", str(nNEIGHs), " ", knn.score(X_test, y_test))

# joblib.dump(knn, "/Users/jamster/knn-A-sexs.xz", compress=9)

# impKNN = joblib.load("/Users/jamster/knn-A-sexs.xz")