...
print("ages, K-nearest neighbor:  ", str(nNEIGHs), " ", knn.score(X_test, y_test))

# joblib.dump(knn, "/Users/jamster/knn-A-ages.xz", compress=9)

# impKNN = joblib.load("/Users/jamster/knn-A-ages.xz")