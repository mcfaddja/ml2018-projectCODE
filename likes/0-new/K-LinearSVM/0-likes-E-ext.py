...
print("exts, Linear SVM:  ", str(myTOL), " ", myRMSE)

# joblib.dump(mySVM, "/Users/jamster/LinearSVM-A-exts.xz", compress=9)

# impSVM = joblib.load("/Users/jamster/LinearSVM-A-exts.xz")