...
#mySVM.fit(likesMAT, neusARR)
mySVM.fit(X_train, y_train)

y_pred = mySVM.predict(X_test)
import math
myRMSE = math.sqrt(metrics.mean_squared_error(y_test, y_pred))
print("neus, Linear SVM:  ", str(myTOL), " ", myRMSE)

# joblib.dump(mySVM, "/Users/jamster/LinearSVM-A-neus.xz", compress=9)

# impSVM = joblib.load("/Users/jamster/LinearSVM-A-neus.xz")