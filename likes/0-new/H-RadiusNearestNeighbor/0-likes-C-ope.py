...
print("opes, Radius neighbors:  ", str(myRAD), " ", myRMSE)

# joblib.dump(radNN, "/Users/jamster/radNN-A-opes.xz", compress=9)

# impRadNN = joblib.load("/Users/jamster/radNN-A-opes.xz")