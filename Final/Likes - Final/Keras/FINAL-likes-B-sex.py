...
numInputs = 650 # Number of nodes to map inputs
...
model.fit(likesMAT, sexsARR, epochs=10)
...
with open("SEXS-Keras.json", "w") as json_file:
    json_file.write(model_json)

# serialize weights to HDF5
print("start writing H5 file")
model.save_weights("SEXS-Keras.h5")

print("Saved SEXS model from Keras to disk")
