...
bagIN.fit(likesMAT, consARR)
# bagIN.fit(X_train, y_train)

# y_pred = bagIN.predict(X_test)
# import math
# myRMSE = math.sqrt(metrics.mean_squared_error(y_test, y_pred))
# print("cons, bagIN:  ", str(nEST), " ", myRMSE)

print("finished training model")

joblib.dump(bagIN, "/Users/jamster/bagIN-A-cons.xz", compress=9)
print("model saved to disk")

impbagIN = joblib.load("/Users/jamster/bagIN-A-cons.xz")
