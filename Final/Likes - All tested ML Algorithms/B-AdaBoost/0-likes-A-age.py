...
nEST=int(sys.argv[2])
lR = float(sys.argv[1])
adaBoost = AdaBoostClassifier(n_estimators=nEST, learning_rate=lR, random_state=myRand)
#adaBoost.fit(likesMAT, sexsARR)
adaBoost.fit(X_train, y_train)

print("ages, adaBoost:  ", str(nEST), " ", str(lR), " ", adaBoost.score(X_test, y_test))

# joblib.dump(adaBoost, "/Users/jamster/adaBoost-A-ages.xz", compress=9)

# impAdaBoost = joblib.load("/Users/jamster/adaBoost-A-ages.xz")