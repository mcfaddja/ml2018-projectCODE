...
print("sexs, LinearSVM:  ", str(myTOL), " ", mySVM.score(X_test, y_test))

# joblib.dump(mySVM, "/Users/jamster/LinearSVM-A-sexs.xz", compress=9)

# impSVM = joblib.load("/Users/jamster/LinearSVM-A-sexs.xz")