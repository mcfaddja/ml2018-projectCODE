...
mySVM = LinearSVC(tol=myTOL)
#mySVM.fit(likesMAT, agesARR)
mySVM.fit(X_train, y_train)

print("ages, Linear SVM:  ", str(myTOL), " ", mySVM.score(X_test, y_test))

# joblib.dump(mySVM, "/Users/jamster/LinearSVM-A-ages.xz", compress=9)

# impSVM = joblib.load("/Users/jamster/LinearSVM-A-ages.xz")